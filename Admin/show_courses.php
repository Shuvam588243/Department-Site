...
$query = "SELECT * FROM subject where cid='$t1' and sem='$t2'";
...
<div class="col-12"> 
 ...
 <td align='center'> <a id='b1' type='button' class='btn btn-primary' data-id=".$result['cid']." data-role='update'> Schedule</a></td>
