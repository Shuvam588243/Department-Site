   ...
   <div class="row">
     <div id = "c1" class="col-4">
       <form method="post">
                               ...
                               <label for="t2"><span class="iconify" data-icon="carbon:phone-filled" data-inline="false"></span>Enter New Password</label>
                                ...
                                <div class="form-group">
                               <label for="t3"><span class="iconify" data-icon="carbon:phone-filled" data-inline="false"></span>Confirm Password</label>
...
$sql = "UPDATE faculties SET  fpass ='$t2' WHERE femail = '$t1'";
