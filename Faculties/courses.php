...
$query = "SELECT * FROM subject where fid='$t1'";
...
<div class="col-12"> 
 ...
 <td align='center' data-target='cname'>".$result['s_name']."</td>
 <td align='center' data-target='cshort'>".$result['code']."</td>
 <td align='center' data-target='ctotsem'>".$result['sem']."</td>
 <td align='center' data-target='ctotyear'>".$result['s_type']."</td>
 
 <td align='center'> <a id='b1' type='button' class='btn btn-primary' data-id=".$result['cid']." data-role='update'> View Details </a></td>
